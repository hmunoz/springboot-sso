...
import ar.unrn.video.membership.client.keycloak.KeycloakAdminClient;
import ar.unrn.video.membership.client.keycloak.dto.KeycloakCredentialDTO;
import ar.unrn.video.membership.client.keycloak.dto.KeycloakTokenResponseDTO;
...
import ar.unrn.video.membership.model.UserCreateRequestDTO;
...
/**
 * Reflection and proxy hints required by GraalVM Native Image for membership-service.
 *
 * <p>Duplicated by design (see docs/arquitectura-dos-servicios.md, decisions D1/D7): this class is
 * split by content, not copied. Keep the shared mechanism in sync with catalog-service.
 */
